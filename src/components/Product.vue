...
<template>
    <div class="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col justify-between">
        <div class="relative group">
            ...
            <div class="absolute top-56 left-0 right-0 bottom-0 bg-black bg-transparent flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div class="flex space-x-2">
                    <RouterLink class="w-28 flex items-center text-center py-2 px-4 bg-white text-gray-700 hover:bg-green-400 hover:text-white rounded shadow-md" :to="{
                    name: 'edit-product',
                    ...
                    <button class="flex items-center w-28 text-center py-2 px-4 bg-white text-gray-700 hover:bg-red-300 hover:text-white rounded shadow-md" 
                    type="button"
        ...
        <div class="border-t p-5 bg-gray-50">
            <div class="mt-1">
                <h4 class="uppercase font-semibold text-gray-900 text-sm">{{ product.name }}</h4>
                <h4 class="flex justify-between mt-1.5">
